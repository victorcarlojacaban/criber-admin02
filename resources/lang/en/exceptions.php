...
return [
	...
	"amenities" => [
	"already_exists" => "That Amenity already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Amenity. Please try again.",
	"delete_error" => "There was a problem deleting this Amenity. Please try again.",
