<!--Action Button-->
@if( Active::checkUriPattern( 'admin/features' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.features.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.features.all' ) }}
            </a>
        </li>
        @permission( 'create-feature' )
            <li>
                <a href="{{ route( 'admin.features.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.features.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
