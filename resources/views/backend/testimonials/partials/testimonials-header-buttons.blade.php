<!--Action Button-->
@if( Active::checkUriPattern( 'admin/testimonials' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.testimonials.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.testimonials.all' ) }}
            </a>
        </li>
        @permission( 'create-testimonial' )
            <li>
                <a href="{{ route( 'admin.testimonials.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.testimonials.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
