<!--Action Button-->
@if( Active::checkUriPattern( 'admin/amenities' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.amenities.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.amenities.all' ) }}
            </a>
        </li>
        @permission( 'create-amenity' )
            <li>
                <a href="{{ route( 'admin.amenities.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.amenities.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
